...
namespace KeyPayV2.Nz.Functions
{
    public class LeaveCategoriesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<NzLeaveCategoryModel> ListLeaveCategories(int businessId)
        {
            return ApiRequest<List<NzLeaveCategoryModel>>($"/business/{businessId}/leavecategory");
        }
        ...
        {
            return ApiRequest<NzLeaveCategoryModel>($"/business/{businessId}/leavecategory/{id}");
        }
