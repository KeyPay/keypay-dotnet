...
namespace KeyPayV2.Nz.Functions
{
    public class LocationFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<NzLocationModel> ListEmployeeLocations(int businessId, int employeeId)
        {
            return ApiRequest<List<NzLocationModel>>($"/business/{businessId}/employee/{employeeId}/location");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<NzLocationModel> ListBusinessLocations(int businessId)
        {
            return ApiRequest<List<NzLocationModel>>($"/business/{businessId}/location");
        }
