...
namespace KeyPayV2.Nz.Functions
{
    public class PayRateTemplateFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<PayRateTemplateExportModel> ListPayRateTemplates(int businessId)
        {
            return ApiRequest<List<PayRateTemplateExportModel>>($"/business/{businessId}/payratetemplate");
        }
