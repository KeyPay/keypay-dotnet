...
using KeyPayV2.Nz.Models.PaymentSummary;
...
namespace KeyPayV2.Nz.Functions
{
    public class PaymentSummaryFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<PaygPaymentSummaryModel> ListPaymentSummaries(int businessId, int financialYearEnding)
        {
            return ApiRequest<List<PaygPaymentSummaryModel>>($"/business/{businessId}/paymentsummary/{financialYearEnding}");
        }
