...
namespace KeyPayV2.Nz.Functions
{
    public class LeaveAllowanceFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<NzLeaveAllowanceTemplateModel> ListLeaveAllowanceTemplates(int businessId)
        {
            return ApiRequest<List<NzLeaveAllowanceTemplateModel>>($"/business/{businessId}/leaveallowancetemplate");
        }
