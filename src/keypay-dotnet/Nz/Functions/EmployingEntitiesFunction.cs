...
namespace KeyPayV2.Nz.Functions
{
    public class EmployingEntitiesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<NzEmployingEntityModel> ListEmployingEntities(int businessId)
        {
            return ApiRequest<List<NzEmployingEntityModel>>($"/business/{businessId}/employingentity");
        }
