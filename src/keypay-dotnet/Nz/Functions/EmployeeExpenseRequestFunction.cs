...
using KeyPayV2.Nz.Models.EmployeeExpenseRequest;
...
namespace KeyPayV2.Nz.Functions
{
    public class EmployeeExpenseRequestFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<ExpenseRequestResponseModel> ListExpenseRequests(int businessId, int employeeId)
        {
            return ApiRequest<List<ExpenseRequestResponseModel>>($"/business/{businessId}/employee/{employeeId}/expenserequest");
        }
