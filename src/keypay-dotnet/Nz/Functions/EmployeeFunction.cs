...
namespace KeyPayV2.Nz.Functions
{
    public class EmployeeFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<List<LeaveBalanceModel>>($"/business/{businessId}/employee/{employeeId}/leavebalances?asAtDate={request.AsAtDate}");
        }
        ...
        {
            return ApiRequest<NzOpeningBalancesModel>($"/business/{businessId}/employee/{employeeId}/openingbalances");
        }
        ...
        /// </remarks>
        public List<WorkTypeModel> GetEmployeeShiftConditions(int businessId, int employeeId)
        {
            return ApiRequest<List<WorkTypeModel>>($"/business/{businessId}/employee/{employeeId}/shiftcondition");
        }
        ...
        /// This operation supports OData queries.
        /// </remarks>
        public List<WorkTypeModel> GetEmployeeWorkTypes(int businessId, int employeeId)
        {
        ...
        /// </remarks>
        public EmployeeDetailsModel ListBasicDetailsForEmployees(int businessId)
        {
            return ApiRequest<EmployeeDetailsModel>($"/business/{businessId}/employee/details");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<NzUnstructuredEmployeeModel> ListEmployees(int businessId, ListEmployeesQueryModel request)
        {
            return ApiRequest<List<NzUnstructuredEmployeeModel>>($"/business/{businessId}/employee/unstructured?payScheduleId={request.PayScheduleId}&locationId={request.LocationId}");
        }
        ...
        {
            return ApiRequest<NzUnstructuredEmployeeModel>($"/business/{businessId}/employee/unstructured/{employeeId}");
        }
        ...
        {
            return ApiRequest<NzUnstructuredEmployeeModel>($"/business/{businessId}/employee/unstructured/externalid/{externalId}");
        }
        ...
        {
            return ApiRequest<NzUnstructuredEmployeeModel>($"/business/{businessId}/employee/unstructured/externalreferenceid/{externalReferenceId}/{source}");
        }
    }
}
