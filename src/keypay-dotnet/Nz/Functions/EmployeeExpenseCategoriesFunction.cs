...
namespace KeyPayV2.Nz.Functions
{
    public class EmployeeExpenseCategoriesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<EmployeeExpenseCategoryModel> ListEmployeeExpenseCategories(int businessId)
        {
            return ApiRequest<List<EmployeeExpenseCategoryModel>>($"/business/{businessId}/employeeexpensecategory");
        }
