...
namespace KeyPayV2.Nz.Functions
{
    public class ManagerFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<List<LeaveBalanceModel>>($"/business/{businessId}/manager/{employeeId}/leaverequest/balances?asAtDate={request.AsAtDate}");
        }
        ...
        /// </remarks>
        public List<LocationModel> ListEmployeeLocations(int businessId, int employeeId)
        {
            return ApiRequest<List<LocationModel>>($"/business/{businessId}/manager/employee/{employeeId}/location");
        }
        ...
        {
            return ApiRequest<PagedResultModel<ManagerExpenseRequestModel>>($"/business/{businessId}/manager/expense?status={request.Status}&fromDate={request.FromDate}&toDate={request.ToDate}&employeeId={request.EmployeeId}&locationId={request.LocationId}&expenseCategoryId={request.ExpenseCategoryId}&groupBy={request.GroupBy}&currentPage={request.CurrentPage}&pageSize={request.PageSize}");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<TimesheetLineModel> GetBusinessTimesheets(int businessId)
        {
            return ApiRequest<List<TimesheetLineModel>>($"/business/{businessId}/manager/kiosk/timesheet");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<LocationModel> ListEmployeeLocations(int businessId)
        {
            return ApiRequest<List<LocationModel>>($"/business/{businessId}/manager/location");
        }
        ...
        {
            return ApiRequest<ManagerRosterShiftModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}");
        }
