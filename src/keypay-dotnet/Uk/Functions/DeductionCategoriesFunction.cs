...
namespace KeyPayV2.Uk.Functions
{
    public class DeductionCategoriesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<UkDeductionCategoryModel> ListDeductionCategories(int businessId)
        {
            return ApiRequest<List<UkDeductionCategoryModel>>($"/business/{businessId}/deductioncategory");
        }
