...
namespace KeyPayV2.Uk.Functions
{
    public class ReportingFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<List<UkLeaveBalancesExportModel>>($"/business/{businessId}/report/leavebalances?locationId={request.LocationId}&leaveTypeId={request.LeaveTypeId}&groupBy={request.GroupBy}&employingEntityId={request.EmployingEntityId}&asAtDate={request.AsAtDate}");
        }
        ...
        {
            return ApiRequest<List<LeaveLiabilityExportModel>>($"/business/{businessId}/report/leaveliability?locationId={request.LocationId}&leaveTypeId={request.LeaveTypeId}&includeApprovedLeave={request.IncludeApprovedLeave}&asAtDate={request.AsAtDate}&employingEntityId={request.EmployingEntityId}");
        }
        ...
        {
            return ApiRequest<List<PensionContributionDataModel>>($"/business/{businessId}/report/pensioncontributions?employeeId={request.EmployeeId}&payRunId={request.PayRunId}&fromDate={request.FromDate}&toDate={request.ToDate}&payScheduleId={request.PayScheduleId}&locationId={request.LocationId}");
        }
