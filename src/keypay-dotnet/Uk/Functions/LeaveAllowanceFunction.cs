...
namespace KeyPayV2.Uk.Functions
{
    public class LeaveAllowanceFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<LeaveAllowanceTemplateApiModel> ListLeaveAllowanceTemplates(int businessId)
        {
            return ApiRequest<List<LeaveAllowanceTemplateApiModel>>($"/business/{businessId}/leaveallowancetemplate");
        }
