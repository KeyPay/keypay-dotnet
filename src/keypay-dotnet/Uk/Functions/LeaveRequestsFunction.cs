...
namespace KeyPayV2.Uk.Functions
{
    public class LeaveRequestsFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<UnitLeaveRequestResponseModel> GetLeaveRequestsForEmployee(int businessId, int employeeId)
        {
            return ApiRequest<List<UnitLeaveRequestResponseModel>>($"/business/{businessId}/employee/{employeeId}/leaverequest");
        }
