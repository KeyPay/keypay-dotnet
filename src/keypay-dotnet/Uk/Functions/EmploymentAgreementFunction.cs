...
namespace KeyPayV2.Uk.Functions
{
    public class EmploymentAgreementFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<BasicEmploymentAgreementModel> ListEmploymentAgreements(int businessId)
        {
            return ApiRequest<List<BasicEmploymentAgreementModel>>($"/business/{businessId}/employmentagreement");
        }
