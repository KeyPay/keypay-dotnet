...
namespace KeyPayV2.Uk.Functions
{
    public class BusinessFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<UkBusinessExportModel> ListBusinesses()
        {
            return ApiRequest<List<UkBusinessExportModel>>($"/business");
        }
        ...
        {
            return ApiRequest<List<BusinessAccessModel>>($"/business/{businessId}/access");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<UkLocationModel> ListEmployeeLocations(int businessId, int employeeId)
        {
            return ApiRequest<List<UkLocationModel>>($"/business/{businessId}/employee/{employeeId}/location");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<UkLocationModel> ListBusinessLocations(int businessId)
        {
            return ApiRequest<List<UkLocationModel>>($"/business/{businessId}/location");
        }
        ...
        /// </summary>
        public void UpdateTheQuickbooksRealmidOnTheBusiness(int businessId, string id)
        {
            ApiRequest($"/business/{businessId}/quickbooksrealmid/{id}", Method.POST);
        }
