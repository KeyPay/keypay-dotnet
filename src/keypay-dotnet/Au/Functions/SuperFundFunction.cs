...
namespace KeyPayV2.Au.Functions
{
    public class SuperFundFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<SelfManagedSuperFundModel> ListSelfManagedSuperFunds(int businessId)
        {
            return ApiRequest<List<SelfManagedSuperFundModel>>($"/business/{businessId}/selfmanagedsuperfund");
        }
