...
namespace KeyPayV2.Au.Functions
{
    public class DeductionCategoriesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<AuDeductionCategoryModel> ListDeductionCategories(int businessId)
        {
            return ApiRequest<List<AuDeductionCategoryModel>>($"/business/{businessId}/deductioncategory");
        }
