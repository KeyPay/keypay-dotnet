...
namespace KeyPayV2.Au.Functions
{
    public class EmployingEntitiesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<AuEmployingEntityModel> ListEmployingEntities(int businessId)
        {
            return ApiRequest<List<AuEmployingEntityModel>>($"/business/{businessId}/employingentity");
        }
