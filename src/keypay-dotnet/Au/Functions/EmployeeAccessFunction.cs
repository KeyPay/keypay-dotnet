...
using KeyPayV2.Au.Models.EmployeeAccess;
...
namespace KeyPayV2.Au.Functions
{
    public class EmployeeAccessFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<EmployeeAccessModel> GetUsersWithAccessToEmployee(int businessId, int employeeId)
        {
            return ApiRequest<List<EmployeeAccessModel>>($"/business/{businessId}/employee/{employeeId}/access");
        }
