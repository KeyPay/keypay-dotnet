...
namespace KeyPayV2.Au.Functions
{
    public class PayRateTemplateFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<AuPayRateTemplateModel> ListPayRateTemplates(int businessId)
        {
            return ApiRequest<List<AuPayRateTemplateModel>>($"/business/{businessId}/payratetemplate");
        }
