...
namespace KeyPayV2.Au.Functions
{
    public class LeaveAllowanceFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<AuLeaveAllowanceTemplateModel> ListLeaveAllowanceTemplates(int businessId)
        {
            return ApiRequest<List<AuLeaveAllowanceTemplateModel>>($"/business/{businessId}/leaveallowancetemplate");
        }
