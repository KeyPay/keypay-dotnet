...
using KeyPayV2.Au.Models.EmployerLiabilityCategories;
...
namespace KeyPayV2.Au.Functions
{
    public class EmployerLiabilityCategoriesFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<EmployerLiabilityCategoryModel> ListEmployerLiabilityCategories(int businessId)
        {
            return ApiRequest<List<EmployerLiabilityCategoryModel>>($"/business/{businessId}/employerliabilitycategory");
        }
