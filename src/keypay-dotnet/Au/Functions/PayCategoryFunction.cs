...
namespace KeyPayV2.Au.Functions
{
    public class PayCategoryFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<AuPayCategoryModel> ListPayCategories(int businessId)
        {
            return ApiRequest<List<AuPayCategoryModel>>($"/business/{businessId}/paycategory");
        }
        ...
        {
            return ApiRequest<AuPayCategoryModel>($"/business/{businessId}/paycategory/{id}");
        }
