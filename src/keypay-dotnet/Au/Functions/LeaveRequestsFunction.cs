...
namespace KeyPayV2.Au.Functions
{
    public class LeaveRequestsFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<HourLeaveRequestResponseModel> GetLeaveRequestsForEmployee(int businessId, int employeeId)
        {
            return ApiRequest<List<HourLeaveRequestResponseModel>>($"/business/{businessId}/employee/{employeeId}/leaverequest");
        }
