...
namespace KeyPayV2.Au.Functions
{
    public class LocationFunction : BaseFunction
    {
        ...
        /// </remarks>
        public List<AuLocationModel> ListEmployeeLocations(int businessId, int employeeId)
        {
            return ApiRequest<List<AuLocationModel>>($"/business/{businessId}/employee/{employeeId}/location");
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<AuLocationModel> ListBusinessLocations(int businessId)
        {
            return ApiRequest<List<AuLocationModel>>($"/business/{businessId}/location");
        }
